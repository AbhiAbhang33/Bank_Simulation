"""
Author:- Abhi
Discription:- This code is written for project on bank simulation
Date:- Jan 23, 2024
"""
...
try:
    ...
    class Bank_account:
                ...
                if Email == Save_Email and password == Save_password :
                    ...
                    while True:
                        ...
                        if choice == 1:
                            ...
                            try:
                                with open(f'transaction_list.txt',mode='r',encoding='utf-8') as file:
        ...
        def transaction(self,trans):
            with open('transaction_list.txt',mode='w',encoding='utf-8') as file:
                file.write(f"{trans} \t\t\t Available Balance: {self.balance} \n")
        
        def DisplayBal(self):
            print('Your updated balance is : ',self.balance)
            with open('transaction_list.txt',mode='r',encoding='utf-8') as file:
                print(file.read())
